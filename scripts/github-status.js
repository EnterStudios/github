module.exports = function(robot) {
  ...
  robot.respond(/github status$/i, function(msg, done) {
    status(msg, done);
  });

  robot.respond(/github status last$/i, function(msg, done) {
    lastMessage(msg, done);
  });

  robot.respond(/github status messages$/i, function(msg, done) {
